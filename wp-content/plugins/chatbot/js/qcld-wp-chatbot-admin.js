        ...
        $.ajax(
            {
              ...
              success: function(data){
                ...
                if(typeof response.responseId !== "undefined"){
                    ...
                    $('.qcwp_df_status').html('<p>Connecton Failed. '+response.error.message+'</p><p class="df-connect-error">If DialogFlow connection is not working, please <a href="https://www.quantumcloud.com/resources/free-support/" target="_blank">contact us</a> for support.</p>');
                }
